...
const config = (env, { mode = "development", port = 9011 }) => {
	return {
		mode,
		resolve: {
		...
		plugins: [
			new ModuleFederationPlugin({
				name: "serviceB",
				filename: "serviceBRemoteEntry.js",
				exposes: {
					"./ServiceBApp": "./src/bootstrap.js",
					"./Summary": "./src/pages/Summary.tsx",
					"./Details": "./src/pages/Details.tsx"
				},
				remotes: {
					utilities: "utilities@http://localhost:9012/utilitiesRemoteEntry.js",
				},
