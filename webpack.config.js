...
const config = (env, { mode = "development", port = 9000 }) => {
	return {
		mode,
		resolve: {
		...
		plugins: [
			new ModuleFederationPlugin({
				...
				remotes: {
					serviceA: "serviceA@http://localhost:9010/serviceARemoteEntry.js",
					serviceB: "serviceB@http://localhost:9011/serviceBRemoteEntry.js"
				},
